...
/** Any helper functions of the framework are set here */

if (!function_exists('env')) {
    /**
     * Custom env function similar to PHP's native getenv
     *
     * @var mixed       $key        The index/key of the ENV variable we are looking for
     * @var mixed|null  $default    The default value should return if nothing found
     * @return mixed
     */
...
if (!function_exists('base_path')) {
    /**
     * Return the absolute path from the root of the framework.
     *
 ...
 * Laravel's helpers
 *
 * Credits to @see https://github.com/rappasoft/laravel-helpers/blob/master/src/helpers.php
 *
 * Note: so far not all of them have been tested thoroughly so errors coulb be expected :-) 
 */
